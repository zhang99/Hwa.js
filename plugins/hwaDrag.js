...
(function ($)
{
    ...
    $.fn.hwaDrag = function (options)
    {
        return l.run.call(this, "hwaDrag", arguments,
        {
            idAttrName: 'hwauidragid', hasElement: false, propertyToElemnt: 'target'
        }
        );
    };

    $.fn.hwaGetDragManager = function ()
    {
        return l.run.call(this, "hwaGetDragManager", arguments,
        {
            idAttrName: 'hwauidragid', hasElement: false, propertyToElemnt: 'target'
        });
    };
    ...
    l.controls.Drag.hwaExtend(l.core.UIComponent, {
        __getType: function ()
        {
            return 'Drag';
        },
        ...
        _rendered: function ()
        {
            this.options.target.hwauidragid = this.id;
        },
        _start: function (e)
        {
            var g = this, p = this.options;

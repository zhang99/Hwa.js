...
(function ($)
{
    ...
    $.fn.hwaButton = function (options)
    {
        return $.hwaui.run.call(this, "hwaButton", arguments);
    };
    $.fn.hwaGetButtonManager = function ()
    {
        return $.hwaui.run.call(this, "hwaGetButtonManager", arguments);
    };
    ...
    $.hwaui.controls.Button = function (element, options)
    {
        $.hwaui.controls.Button.base.constructor.call(this, element, options);
    };
    $.hwaui.controls.Button.hwaExtend($.hwaui.controls.Input, {
        __getType: function ()
        {
            return 'Button';
        },
